...
public class HomePage {
    ...
    By homeLink = By.xpath("//nav/ul/li/a[@href='index.html']");
    By accordionLink = By.xpath("//nav/ul/li/a[@href='accordion.html']");
    By browserTabLink = By.xpath("//nav/ul/li/a[@href='browserTabs.html']");
    By buttonsLink = By.xpath("//nav/ul/li/a[@href='buttons.html']");
